                ...
                <div className="md:flex justify-between items-center">
                    <div>
                        ...
                        <ul className="tracking-[0.5px] inline-flex items-center mt-2">
                            ...
                            <li className="inline-block capitalize text-[16px] font-medium text-primary dark:text-white" aria-current="page">FAQs</li>
                        </ul>
                    </div>
                    ...
                    <div className={`${show ? '' : 'hidden'} fixed z-50  flex items-center justify-center overflow-hidden m-auto bg-slate-900/70 dark:bg-slate-900/50 inset-0`}>
                                ...
                                <div className="p-4">                        
                                    <form>
                                        <div className="grid grid-cols-12 gap-3">
                                            ...
                                            <div className="col-span-12">
                                                <button type="submit" className="btn bg-primary hover:bg-primary-dark text-white rounded-md">Add Q&A</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>                    
                        ...
                        <div id="accordion-collapsetwo" data-accordion="collapse" className="mt-6">
                            {accordianData.map((item, index) =>{
                                return(
                                    <div className="relative shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md overflow-hidden mt-4" key={index}>
                                        <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                                            <button type="button" className={`${accordion2 === index ? ' bg-gray-50 dark:bg-slate-800 text-primary' :' text-dark dark:text-white'} flex justify-between items-center p-5 w-full font-medium text-start`} onClick={() =>setAccordion2(index)}>
                                                <span>{item.title}</span>
                        ...
                        <div id="accordion-collapsethree" data-accordion="collapse" className="mt-6">
                            {accordianData.map((item, index) =>{
                                return(
                                    <div className="relative shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md overflow-hidden mt-4" key={index}>
                                        <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                                            <button type="button" className={`${accordion3 === index ? ' bg-gray-50 dark:bg-slate-800 text-primary' :' text-dark dark:text-white'} flex justify-between items-center p-5 w-full font-medium text-start`} onClick={() =>setAccordion3(index)}>
                                                <span>{item.title}</span>
                        ...
                        <div id="accordion-collapsefour" data-accordion="collapse" className="mt-6">
                            {accordianData.map((item, index) =>{
                                return(
                                    <div className="relative shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md overflow-hidden mt-4" key={index}>
                                        <h2 className="text-base font-semibold" id="accordion-collapse-heading-1">
                                            <button type="button" className={`${accordion4 === index ? ' bg-gray-50 dark:bg-slate-800 text-primary' :' text-dark dark:text-white'} flex justify-between items-center p-5 w-full font-medium text-start`} onClick={() =>setAccordion4(index)}>
                                                <span>{item.title}</span>
