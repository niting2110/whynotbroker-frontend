                                ...
                                <div className="group text-center">
                                    <div className="relative inline-block mx-auto h-52 w-52 !rounded-full overflow-hidden">
                                        ...
                                        <ul className="list-none absolute start-0 end-0 -bottom-20 group-hover:bottom-5 transition-all duration-500 ease-in-out">
                                            <li className="inline ms-1"><Link href="#" className="btn btn-icon btn-sm !rounded-full border border-primary bg-primary hover:border-primary hover:bg-primary text-white"><FiFacebook  className="h-4 w-4" /></Link></li>
                                            <li className="inline ms-1"><Link href="#" className="btn btn-icon btn-sm !rounded-full border border-primary bg-primary hover:border-primary hover:bg-primary text-white"><FiInstagram  className="h-4 w-4" /></Link></li>
                                            <li className="inline ms-1"><Link href="#" className="btn btn-icon btn-sm !rounded-full border border-primary bg-primary hover:border-primary hover:bg-primary text-white"><FiLinkedin className="h-4 w-4" /></Link></li>
                                        </ul>
                                    </div>
