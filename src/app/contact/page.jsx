...
import { FiHexagon, FiMapPin, FiMail, FiPhone } from 'react-icons/fi';
                ...
                <div className="container lg:mt-24 mt-16">
                    <div className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-[30px]">
                        {contactDetails.map((item,index)=>{
                            const Icon = item.Icon === "FiMapPin" ? FiMapPin : item.Icon === "FiMail" ? FiMail : FiPhone
                            return(
                                <div className="text-center px-6" key={index}>
                                <div className="relative overflow-hidden text-transparent -m-3">
                                    <FiHexagon className="h-32 w-32 fill-primary/5 mx-auto" />
                                ...
                                <div className="content mt-7">
                                    ...
                                    <div className="mt-5">
                                        <Link href="tel:+152534-468-854" className="btn btn-link text-primary hover:text-primary after:bg-primary transition duration-500">{item.contact}</Link>
                                    </div>
                                </div>
                            </div>
                            )
