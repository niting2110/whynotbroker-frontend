                ...
                <div className="layout-specing">
                    <div className="md:flex justify-between items-center">
                        ...
                        <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                            ...
                            <li className="inline-block capitalize text-[16px] font-medium text-primary dark:text-white" aria-current="page">Terms</li>
                        </ul>
                    </div>
                            ...
                            <div className="lg:w-4/5 w-full">
                                <div className="p-6 bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md">
                                    ...
                                    <ul className="list-none text-slate-400 mt-3">
                                        <li className="flex mt-2 ms-0 items-center"><i className="mdi mdi-arrow-right text-primary text-lg align-middle me-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                        <li className="flex mt-2 ms-0 items-center"><i className="mdi mdi-arrow-right text-primary text-lg align-middle me-2"></i>Our Talented & Experienced Marketing Agency</li>
                                        <li className="flex mt-2 ms-0 items-center"><i className="mdi mdi-arrow-right text-primary text-lg align-middle me-2"></i>Create your own skin to match your brand</li>
                                        <li className="flex mt-2 ms-0 items-center"><i className="mdi mdi-arrow-right text-primary text-lg align-middle me-2"></i>Digital Marketing Solutions for Tomorrow</li>
                                        <li className="flex mt-2 ms-0 items-center"><i className="mdi mdi-arrow-right text-primary text-lg align-middle me-2"></i>Our Talented & Experienced Marketing Agency</li>
                                        <li className="flex mt-2 ms-0 items-center"><i className="mdi mdi-arrow-right text-primary text-lg align-middle me-2"></i>Create your own skin to match your brand</li>
                                    </ul>
                                   ...
                                   <Accordian/>
                                    ...
                                    <div className="mt-6">
                                        <Link href="" className="btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md">Accept</Link>
                                        <Link href="" className="btn bg-transparent hover:bg-primary border border-primary text-primary hover:text-white rounded-md ms-2">Decline</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
