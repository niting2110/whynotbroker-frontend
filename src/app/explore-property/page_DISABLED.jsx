            ...
            <div className="layout-specing">
                <div className="md:flex justify-between items-center">
                    ...
                    <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                        ...
                        <li className="inline-block capitalize text-[16px] font-medium text-primary dark:text-white" aria-current="page">Properties</li>
                    </ul>
                </div>
                                ...
                                <div className="p-6">
                                    ...
                                    <ul className="py-6 border-y border-slate-100 dark:border-gray-800 flex items-center list-none">
                                        <li className="flex items-center me-4">
                                            <i className="mdi mdi-arrow-expand-all text-2xl me-2 text-primary"></i>
                                            <span>{item.sqf}</span>
                                        </li>

                                        <li className="flex items-center me-4">
                                            <i className="mdi mdi-bed text-2xl me-2 text-primary"></i>
                                            <span>{item.beds}</span>
                                        </li>

                                        <li className="flex items-center">
                                            <i className="mdi mdi-shower text-2xl me-2 text-primary"></i>
