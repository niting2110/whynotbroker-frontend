                ...
                <div className="md:flex justify-center">
                    <div className="lg:w-2/5">
                        <div className="relative overflow-hidden rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800">
                            <div className="px-6 py-12 bg-primary text-center">
                            ...
                            <div className="px-6 py-12 text-center">
                                ...
                                <div className="mt-6">
                                    <Link href="/" className="btn bg-primary hover:bg-primary-dark border-primary hover:border-greenbg-primary-dark text-white rounded-md">Continue</Link>
                                </div>
                            </div>
