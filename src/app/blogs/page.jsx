                            ...
                            <div key={index} className="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow-sm shadow-gray-200 dark:shadow-gray-700 transition-all duration-500">
                                ...
                                <div className="relative p-6">
                                    <div className="">
                                        ...
                                        <div className="mt-3">
                                            <Link href={`/blog-detail/${item.id}`} className="btn btn-link hover:text-primary after:bg-primary duration-500 ease-in-out inline-flex items-center"><span>Read More</span><FiArrowRight /></Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
