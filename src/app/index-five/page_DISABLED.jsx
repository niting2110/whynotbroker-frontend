            ...
            <div className="container">
                <div className="grid grid-cols-1">
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 mx-auto text-xl max-w-xl">Karnataka's trusted property portal. Buy, sell, rent directly.</p>
                        ...
                        <div className="subcribe-form relative z-1 mt-8">
                            <form className="relative max-w-2xl mx-auto">
                                ...
                                <button type="submit" className="btn bg-primary hover:bg-primary-700 text-white !rounded-full">Find Properties</button>
                            </form>
                        </div>
                    </div>
