...
import UplodProfileImg from "../components/uplod-profile-img";
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div className="p-6 relative rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                    ...
                                    <form>
                                        <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input type="text" className="form-input !ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border !border-gray-200 focus:!border-primary dark:!border-gray-800 dark:focus:!border-primary focus:ring-0" placeholder="First Name:" id="firstname" name="name" required=""/>
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input type="text" className="form-input !ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border !border-gray-200 focus:!border-primary dark:!border-gray-800 dark:focus:!border-primary focus:ring-0" placeholder="Last Name:" id="lastname" name="name" required=""/>
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <div className="form-icon relative mt-2">
                                                    ...
                                                    <input type="email" className="form-input !ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border !border-gray-200 focus:!border-primary dark:!border-gray-800 dark:focus:!border-primary focus:ring-0" placeholder="Email" name="email" required=""/>
                                                </div>
                                            </div>
                                            <div>
                                        ...
                                        <input type="submit" id="submit" name="send" className="btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md mt-5" value="Save Changes"/>
                                    </form>
                                </div>
                                    ...
                                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-6">
                                        <div>
                                            ...
                                            <form>
                                                ...
                                                <button className="btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md mt-5">Add</button>
                                            </form>
                                        </div> 
                                                ...
                                                <div className="grid grid-cols-1 gap-5">
                                                    <div>
                                                        ...
                                                        <div className="form-icon relative mt-2">
                                                            ...
                                                            <input type="password" className="form-input !ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border !border-gray-200 focus:!border-primary dark:!border-gray-800 dark:focus:!border-primary focus:ring-0" placeholder="Old password" required=""/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="form-icon relative mt-2">
                                                            <FiKey className="w-4 h-4 absolute top-3 start-4"/>
                                                            <input type="password" className="form-input !ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border !border-gray-200 focus:!border-primary dark:!border-gray-800 dark:focus:!border-primary focus:ring-0" placeholder="New password" required=""/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="form-icon relative mt-2">
                                                            <FiKey className="w-4 h-4 absolute top-3 start-4"/>
                                                            <input type="password" className="form-input !ps-12 w-full py-2 px-3 h-10 bg-transparent dark:bg-slate-900 dark:text-slate-200 rounded outline-none border !border-gray-200 focus:!border-primary dark:!border-gray-800 dark:focus:!border-primary focus:ring-0" placeholder="Re-type New password" required=""/>
                                                        </div>
                                                    </div>
                                                </div>
            
                                                <button className="btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md mt-5">Save password</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
