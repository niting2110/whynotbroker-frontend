...
export default function Navbar(props) {
    let { navClass, topnavClass, tagline } = props;
                ...
                <div className={`${topnavClass !== '' && topnavClass !== undefined ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                    ...
                    <ul className="buy-button list-none mb-0">
                        <li className="inline mb-0">
                            <Link href="/auth-login" className="btn btn-icon bg-primary hover:bg-primary-700 border-primary dark:border-primary text-white !rounded-full"><User className="h-4 w-4 stroke-[3]"></User></Link>
                        </li>
                        <li className="sm:inline ps-1 mb-0 hidden">
                            <Link href="/auth-signup" className="btn bg-primary hover:bg-primary-700 border-primary dark:border-primary text-white !rounded-full">Signup</Link>
                        </li>
                    </ul>
                    {/* <!--Login button End--> */}
                    ...
                    <div id="navigation" className={`${isOpen === true ? 'hidden' : 'block'}`} >
                        ...
                        <ul className={`navigation-menu  ${navClass === '' || navClass === undefined ? '' : 'nav-light'}   ${topnavClass !== '' && topnavClass !== undefined ? '!justify-center' : '!justify-end'}`}>
                            <li className={`has-submenu parent-menu-item ${["/", "/index-two", "/index-three", "/index-four","/index-five", "/index-six", "/index-seven","/index-eight","/index-nine","/index-ten","/index-eleven","/index-twelve"].includes(manu) ? 'active' : ''}`}>
                                ...
                                <ul className={`submenu megamenu ${["/", "/index-two", "/index-three", "/index-four", "/index-five", "/index-six","/index-seven","/index-item","/index-eight","/index-nine","/index-ten"].includes(subManu) ? 'open' : ''}`}>
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <ul>
                                            <li className={manu ===  "/index-eleven" ? 'active' : '' }>
                                                <Link href="/index-eleven" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-eleven.png' width={183} height={124} className="img-fluid rounded shadow-md" alt=""/></span>
                                                        <span className="lg:mt-2 block">Hero Eleven<span className="bg-red inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></span>
                                                    </div>
                                                </Link>
                                            </li>
                                            <li className={manu ===  "/index-twelve" ? 'active' : '' }>
                                                <Link href="/index-twelve" className="sub-menu-item">
                                                    <div className="lg:text-center">
                                                        <span className="none lg:block"><Image src='/images/demos/hero-twelve.png' width={183} height={124} className="img-fluid rounded shadow-md" alt=""/></span>
                                                        <span className="lg:mt-2 block">Hero Twelve <span className="bg-red inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">New</span></span>
                                                    </div>
                                                </Link>
                                            </li>
                                        </ul>
