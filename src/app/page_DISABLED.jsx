...
const MapVactor = dynamic(()=>import('./components/map-vactor'),{ssr:false})
            ...
            <div className="layout-specing">
                        ...
                        return(
                            <div className="relative overflow-hidden rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700 bg-white dark:bg-slate-900" key={index}>
                                <div className="p-5 flex items-center justify-between">
                                    ...
                                    <span className="flex justify-center items-center rounded-md h-12 w-12 min-w-[48px] bg-slate-50 dark:bg-slate-800 shadow-sm shadow-gray-100 dark:shadow-gray-700 text-primary">
                ...
                <div className="grid lg:grid-cols-12 grid-cols-1 mt-6 gap-6">
                    ...
                    <div className="lg:col-span-4">
                        <div className="relative overflow-hidden rounded-md shadow-sm shadow-gray-200m dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            <div className="p-6 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                                    ...
                                    return(
                                        <div className="mt-5" key={index}>
                                            ...
                                            <div className="w-full bg-gray-100 dark:bg-gray-800 !rounded-full h-[6px]">
                                                <div className="bg-primary h-[6px] !rounded-full" style={{width: item.sale}}></div>
                                            </div>
                                        </div>
                                    )
                                })}
                    ...
                    <div className="xl:col-span-6 lg:col-span-12 xl:order-2 order-3">
                        <div className="relative overflow-hidden rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            <div className="p-6 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                                ...
                                <Link href="" className="btn btn-link font-normal text-slate-400 hover:text-primary after:bg-primary transition duration-500">View orders <i className="mdi mdi-arrow-right ms-1"></i></Link>
                            </div>
                                                ...
                                                <tr key={index}>
                                                    <th className="text-start border-t border-gray-100 dark:border-gray-800 px-4 py-3 font-semibold">
                                                        <div className="relative md:shrink-0">
                                                            <Image src={item.image} width={48} height={48} className="object-cover w-12 h-12 min-w-[48px] rounded-md shadow-sm dark:shadow-gray-700" alt=""/>
                                                        </div>
                                                    </th>
                    ...
                    <div className="xl:col-span-3 lg:col-span-6 xl:order-3 order-2">
                        <div className="relative overflow-hidden rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700 bg-white dark:bg-slate-900">
                            <div className="p-6 flex items-center justify-between border-b border-gray-100 dark:border-gray-800">
                                ...
                                <Link href="" className="btn btn-link font-normal text-slate-400 hover:text-primary after:bg-primary transition duration-500">See More <i className="mdi mdi-arrow-right ms-1"></i></Link>
                            </div>
                                    ...
                                    return(
                                        <div className="flex justify-between items-center mt-4" key={index}>
                                            <div className="flex items-center">
                                                ...
                                                <div className="ms-2">
                                                    <Link href="" className="font-medium hover:text-primary block text-lg">{item.name}</Link>
