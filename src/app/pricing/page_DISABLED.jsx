                ...
                <div className="layout-specing">
                    <div className="md:flex justify-between items-center">
                        ...
                        <ul className="tracking-[0.5px] inline-flex items-center sm:mt-0 mt-3">
                            ...
                            <li className="inline-block capitalize text-[16px] font-medium text-primary dark:text-white" aria-current="page">Pricing</li>
                        </ul>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6 mt-6">
                        {pricingData.map((item, index) =>{
                            return(
                                <div className="rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 duration-500 ease-in-out" key={index}>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <ul className="list-none">
                                            {item.feature.map((el,index) =>{
                                                return(
                                                    <li className="text-slate-400 mt-2 ms-0" key={index}><span className="text-primary text-lg me-2"><i className="mdi mdi-check-circle-outline align-middle"></i></span>{el}</li>
                                                )
                                            })}
                                        </ul>
                                        
                                        <Link href="" className="btn bg-primary hover:bg-primary-dark border-primary dark:border-primary text-white rounded-md w-full mt-4">Get Started</Link>
                                    </div>
                                </div>
                            )
                        })}
