                    ...
                    <li className="dropdown inline-block relative">
                        ...
                        <div className={`${showCountry ? 'show' : 'hidden'} dropdown-menu absolute end-0 m-0 mt-4 z-10 w-36 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700`}>
                            <ul className="list-none py-2 text-start">
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/germany.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm  shadow-gray-200 dark:shadow-gray-700" alt=""/> German</Link>
                                </li>
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/germany.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm shadow-gray-200 dark:shadow-gray-700" alt=""/> Italian</Link>
                                </li>
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/russia.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm  shadow-gray-200 dark:shadow-gray-700" alt=""/> Russian</Link>
                                </li>
                                <li className="my-1">
                                    <Link href="" className="flex items-center text-[15px] font-medium py-1.5 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><Image src='/images/flags/spain.png' width={24} height={24} className="h-6 w-6 rounded-md me-2 shadow-sm shadow-gray-200 dark:shadow-gray-700" alt=""/> Spanish</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
                            ...
                            <SimpleBar className="h-64">
                                <ul className="py-2 text-start h-64 border-t border-gray-100 dark:border-gray-800">
                                    <li>
                                        <Link href="#!" className="block font-medium py-1.5 px-4">
                                            <div className="flex items-center">
                                                <div className="h-10 w-10 rounded-md shadow-sm shadow-primary/10  dark:shadow-gray-700 bg-primary/10 dark:bg-slate-800 text-primary dark:text-white flex items-center justify-center">
                                    ...
                                    <li>
                                        <Link href="#!" className="block font-medium py-1.5 px-4">
                                            <div className="flex items-center">
                                                <Image src='/images/client/04.jpg' width={40} height={40} className="h-10 w-10 rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700" alt=""/>
                                                <div className="ms-2">
                                    ...
                                    <li>
                                        <Link href="#!" className="block font-medium py-1.5 px-4">
                                            <div className="flex items-center">
                                                <Image src='/images/client/05.jpg' width={40} height={40} className="h-10 w-10 rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700" alt=""/>
                                                <div className="ms-2">
                    ...
                    <li className="dropdown inline-block relative">
                        ...
                        <div className={`${user ? 'show' : 'hidden'} dropdown-menu absolute end-0 m-0 mt-4 z-10 w-44 rounded-md overflow-hidden bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700`}>
                            <ul className="py-2 text-start">
                                <li>
                                    <Link href="/profile" onClick={() => setUser(false)} className="block py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><i className="mdi mdi-account-outline me-2"></i>Profile</Link>
                                </li>
                                <li>
                                    <Link href="/chat" onClick={() => setUser(false)} className="block py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><i className="mdi mdi-chat-outline me-2"></i>Chat</Link>
                                </li>
                                <li>
                                    <Link href="/profile-setting" onClick={() => setUser(false)} className="block py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><i className="mdi mdi-cog-outline me-2"></i>Settings</Link>
                                </li>
                                <li className="border-t border-gray-100 dark:border-gray-800 my-2"></li>
                                <li>
                                    <Link href="/lock-screen" onClick={() => setUser(false)} className="block py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><i className="mdi mdi-lock-outline me-2"></i>Lockscreen</Link>
                                </li>
                                <li>
                                    <Link href="/login" onClick={() => setUser(false)} className="block py-1 px-4 dark:text-white/70 hover:text-primary dark:hover:text-white"><i className="mdi mdi-logout me-2"></i>Logout</Link>
                                </li>
                            </ul>
                        </div>
                    </li>
