...
export default function ImageUpload(){
    ...
    return(
        <div>
            ...
            <label className="btn-upload btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md mt-6 cursor-pointer" htmlFor="input-file">Upload Image</label>
        </div>
    )
}