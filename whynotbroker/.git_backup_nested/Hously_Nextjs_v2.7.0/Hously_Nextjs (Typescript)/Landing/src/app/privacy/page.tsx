                    ...
                    <div className="md:flex justify-center">
                        ...
                        <div className="p-6 bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md">
                                ...
                                <ul className="list-unstyled text-slate-400 mt-4">
                                    <li className="flex mt-2"><FiArrowRight className="text-primary align-middle me-2"/>Digital Marketing Solutions for Tomorrow</li>
                                    <li className="flex mt-2"><FiArrowRight className="text-primary align-middle me-2"/>Our Talented & Experienced Marketing Agency</li>
                                    <li className="flex mt-2"><FiArrowRight className="text-primary align-middle me-2"/>Create your own skin to match your brand</li>
                                    <li className="flex mt-2"><FiArrowRight className="text-primary align-middle me-2"/>Digital Marketing Solutions for Tomorrow</li>
                                    <li className="flex mt-2"><FiArrowRight className="text-primary align-middle me-2"/>Our Talented & Experienced Marketing Agency</li>
                                    <li className="flex mt-2"><FiArrowRight className="text-primary align-middle me-2"/>Create your own skin to match your brand</li>
                                </ul>
                                ...
                                <div className="mt-8">
                                    <Link href="#" onClick={()=>window.print()} className="btn bg-primary hover:bg-primary-dark text-white rounded-md">Print</Link>
                                </div>
                            </div>
                        </div>
                    </div>
