            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                <div className="md:col-span-4">
                    <div className="md:text-start text-center">
                        ...
                        <div className="mt-4">
                            <Link href="#" className="btn bg-primary hover:bg-primary-dark text-white rounded-md md:mt-20">Learn More <i className="mdi mdi-arrow-right ms-1 align-middle"></i></Link>
                        </div>
                    </div>
                </div>
