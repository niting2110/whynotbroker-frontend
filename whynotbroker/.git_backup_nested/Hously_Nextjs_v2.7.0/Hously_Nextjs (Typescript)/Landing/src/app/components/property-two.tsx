                                        ...
                                        <div className="p-6">
                                            ...
                                            <ul className="py-6 border-y border-slate-100 dark:border-gray-800 flex items-center list-none">
                                                <li className="flex items-center me-4">
                                                    <LiaCompressArrowsAltSolid className="me-2 text-primary text-2xl" width={20}/>
                                                    <span>8000sqf</span>
                                                </li>

                                                <li className="flex items-center me-4">
                                                    <LuBedDouble className="me-2 text-primary text-2xl" width={20}/>
                                                    <span>4 Beds</span>
                                                </li>

                                                <li className="flex items-center">
                                                    <LuBath className="me-2 text-primary text-2xl" width={20}/>
                                                    <span>4 Baths</span>
                                                </li>
                                            </ul>
