                ...
                <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
                    <div className="md:col-span-5">
                        <div className="relative">
                            ...
                            <div className="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                <Link href="#" scroll={false}  onClick={()=>setOpen(!isOpen)} className="lightbox h-20 w-20 !rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-primary">
                    ...
                    <div className="md:col-span-7">
                        <div className="lg:ms-4">
                            ...
                            <div className="mt-4">
                                <Link href="#" className="btn bg-primary hover:bg-primary-dark text-white rounded-md mt-3">Learn More </Link>
                            </div>
                        </div>
                    </div>
                </div>
