                ...
                <div className={`${topnavClass !== '' && topnavClass !== undefined ? 'container-fluid md:px-8 px-3' : 'container'}`}>
                    ...
                    <ul className="buy-button list-none mb-0">
                        <li className="inline mb-0">
                            <Link href="/auth-login" className="btn btn-icon bg-primary hover:bg-primary-dark border-primary dark:border-primary text-white !rounded-full"><User className="h-4 w-4 stroke-[3]"></User></Link>
                        </li>
                        <li className="sm:inline ps-1 mb-0 hidden">
                            <Link href="/auth-signup" className="btn bg-primary hover:bg-primary-dark border-primary dark:border-primary text-white !rounded-full">Signup</Link>
                        </li>
                    </ul>
                    {/* <!--Login button End--> */}
