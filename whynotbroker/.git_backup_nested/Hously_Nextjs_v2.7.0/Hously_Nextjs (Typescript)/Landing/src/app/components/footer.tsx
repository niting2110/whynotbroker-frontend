                                ...
                                <div className="grid md:grid-cols-12 grid-cols-1 gap-[30px] -mt-24">
                                    ...
                                    <div className="lg:col-span-3 md:col-span-4">
                                        ...
                                        <div className="flex mt-6">
                                            <FiMapPin  className="w-5 h-5 text-primary me-3"></FiMapPin >
                                            <div className="">
                                        ...
                                        <div className="flex mt-6">
                                            <FiMail className="w-5 h-5 text-primary me-3"></FiMail>
                                            <div className="">
                                        ...
                                        <div className="flex mt-6">
                                            <FiPhone className="w-5 h-5 text-primary me-3"></FiPhone >
                                            <div className="">
