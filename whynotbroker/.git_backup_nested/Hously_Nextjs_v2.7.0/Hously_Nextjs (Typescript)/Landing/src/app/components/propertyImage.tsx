            ...
            <div className="lg:w-1/2 md:w-1/2 p-1">
                <div className="group relative overflow-hidden">
                    ...
                    <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                        <Link href="#" onClick={() => handleCLick(0)} className="btn btn-icon bg-primary hover:bg-primary-dark text-white !rounded-full lightbox"><FiCamera width={18}/></Link>
                    </div>
                </div>
            </div>
                ...
                <div className="flex">
                    <div className="w-1/2 p-1">
                        <div className="group relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                <Link href="#" onClick={() => handleCLick(1)} className="btn btn-icon bg-primary hover:bg-primary-dark text-white !rounded-full lightbox"><FiCamera width={18}/></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-1/2 p-1">
                        <div className="group relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                <Link href="#" onClick={() => handleCLick(2)} className="btn btn-icon bg-primary hover:bg-primary-dark text-white !rounded-full lightbox"><FiCamera width={18}/></Link>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex">
                    <div className="w-1/2 p-1">
                        <div className="group relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                <Link href="#" onClick={() => handleCLick(3)} className="btn btn-icon bg-primary hover:bg-primary-dark text-white !rounded-full lightbox"><FiCamera width={18}/></Link>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-1/2 p-1">
                        <div className="group relative overflow-hidden">
                            ...
                            <div className="absolute inset-0 group-hover:bg-slate-900/70 duration-500 ease-in-out"></div>
                            <div className="absolute top-1/2 -translate-y-1/2 start-0 end-0 text-center invisible group-hover:visible">
                                <Link href="#" onClick={() => handleCLick(4)} className="btn btn-icon bg-primary hover:bg-primary-dark text-white !rounded-full lightbox"><FiCamera width={18}/></Link>
                            </div>
                        </div>
                    </div>
                </div>
