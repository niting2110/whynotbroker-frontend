                        ...
                        <div className="md:w-3/4">
                            <div className="p-6 bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700 rounded-md">
                                ...
                                <ul className="list-none text-slate-400 mt-3">
                                    <li className="flex mt-2"><FiArrowRight className=" text-primary align-middle me-2"/> <span>Digital Marketing Solutions for Tomorrow</span></li>
                                    <li className="flex mt-2"><FiArrowRight className=" text-primary align-middle me-2"/> <span>Our Talented & Experienced Marketing Agency</span></li>
                                    <li className="flex mt-2"><FiArrowRight className=" text-primary align-middle me-2"/> <span>Create your own skin to match your brand</span></li>
                                    <li className="flex mt-2"><FiArrowRight className=" text-primary align-middle me-2"/> <span>Digital Marketing Solutions for Tomorrow</span></li>
                                    <li className="flex mt-2"><FiArrowRight className=" text-primary align-middle me-2"/> <span>Our Talented & Experienced Marketing Agency</span></li>
                                    <li className="flex mt-2"><FiArrowRight className=" text-primary align-middle me-2"/> <span>Create your own skin to match your brand</span></li>
                                </ul>
                               ...
                               <Accordion/>
                                ...
                                <div className="mt-6">
                                    <Link href="#" className="btn bg-primary hover:bg-primary-dark text-white rounded-md">Accept</Link>
