                                                    ...
                                                    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-0 gap-6">
                                                        ...
                                                        <div>
                                                            <div className="md:mt-8">
                                                                <input type="submit" id="search-buy" name="search" className="btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white searchbtn submit-btn w-full !h-[60px] rounded lg:rounded-none" value="Search" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
