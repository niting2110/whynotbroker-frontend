                                ...
                                <div className="p-6 rounded-md shadow-sm dark:shadow-gray-700 bg-white dark:bg-slate-900">
                                    <div className="border-b border-gray-100 dark:border-gray-700 pb-6">
                                        <div className="md:flex justify-between">
                                            <div>
                                                <img src='/images/logo-dark.png' className="block dark:hidden" alt=""/>
                                            ...
                                            <div className="mt-6 md:mt-0 md:w-56">
                                                ...
                                                <ul className="list-none">
                                                    <li className="flex mt-3">
                                                        <FiMapPin className="size-4 me-3 mt-1"/>
                                                    ...
                                                    <li className="flex mt-3">
                                                        <FiPhone className="size-4 me-3 mt-1"/>
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <ul className="list-none">
                                                <li className="flex mt-3">
                                                    ...
                                                    <span className="text-slate-400">#h003</span>
                                                </li>
                                        ...
                                        <div className="mt-3 md:w-56">
                                            <ul className="list-none">
                                                <li className="flex mt-3">
                                                    ...
                                                    <span className="text-slate-400">16th Aug 2024</span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
