...
export default function PropertyDetail(){
    ...
    const data:PropertiesData | undefined = propertiesData.find((user) => user?.id === id);
    return(
        <Wrapper>
                    ...
                    <div className="grid lg:grid-cols-12 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div className="bg-white dark:bg-slate-900 p-6 rounded-md shadow-sm shadow-gray-200 dark:shadow-gray-700">
                                ...
                                <ul className="py-6 flex items-center list-none">
                                    <li className="flex items-center lg:me-6 me-4">
                                        <i className="mdi mdi-arrow-expand-all lg:text-3xl text-2xl me-2 text-primary"></i>
                                        <span className="lg:text-xl">8000sqf</span>
                                    </li>

                                    <li className="flex items-center lg:me-6 me-4">
                                        <i className="mdi mdi-bed lg:text-3xl text-2xl me-2 text-primary"></i>
                                        <span className="lg:text-xl">4 Beds</span>
                                    </li>

                                    <li className="flex items-center">
                                        <i className="mdi mdi-shower lg:text-3xl text-2xl me-2 text-primary"></i>
                        ...
                        <div className="lg:col-span-4">
                            <div className="rounded-md bg-white dark:bg-slate-900 shadow-sm shadow-gray-200 dark:shadow-gray-700">
                                ...
                                <div className="flex">
                                    <div className="p-1 w-1/2">
                                        <Link href="" className="btn bg-primary hover:bg-primary-dark text-white rounded-md w-full">Book Now</Link>
                                    </div>
                                    <div className="p-1 w-1/2">
                                        <Link href="" className="btn bg-primary hover:bg-primary-dark text-white rounded-md w-full">Offer Now</Link>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="mt-12 text-center">
                                ...
                                <div className="mt-6">
                                    <Link href="/contact" className="btn bg-transparent hover:bg-primary border border-primary text-primary hover:text-white rounded-md"><i className="mdi mdi-phone align-middle me-2"></i> Contact us</Link>
                                </div>
                            </div>
                        </div>
                    </div>
