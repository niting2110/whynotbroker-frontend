        ...
        <section className="h-screen flex items-center justify-center relative overflow-hidden bg-no-repeat bg-center bg-cover" style={{backgroundImage:`url('/images/01.jpg')`}}>
            ...
            <div className="container relative">
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1">
                    <div className="p-6 bg-white dark:bg-slate-900 shadow-md shadow-gray-200 dark:shadow-gray-800 rounded-md">
                        <div className="text-center">
                            <Image src='/images/client/07.jpg' width={80} height={80} className="mx-auto h-20 w-20 !rounded-full shadow-sm shadow-gray-200 dark:shadow-gray-800" alt=""/>
                        ...
                        <form>
                            <div className="grid grid-cols-1">
                                <div className="mb-4 ltr:text-left rtl:text-right">
                                    ...
                                    <input id="LoginPassword" type="password" className="form-input border !border-gray-200 dark:!border-gray-800 mt-3 rounded-md" required="" placeholder="Password:"/>
                                </div>
                                ...
                                <div className="mb-4">
                                    <input type="submit" className="btn bg-primary hover:bg-primary-dark border-primary hover:border-primary-dark text-white rounded-md w-full" value="Login / Sign in"/>
                                </div>
                            </div>
                        </form>
                    </div>
