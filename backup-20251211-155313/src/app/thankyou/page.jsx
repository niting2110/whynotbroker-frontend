            ...
            <div className="container relative">
                <div className="grid grid-cols-1">
                    <div className="title-heading text-center my-auto">
                        <div className="w-24 h-24 bg-primary/5 text-primary rounded-md flex align-middle justify-center items-center shadow-xs shadow-gray-200 dark:shadow-gray-800 mx-auto">
