        ...
        <ul className="list-none text-center md:flex justify-between">
            <li>
                <ul className="text-md-start brokerage-form list-none">
                    ...
                    <li><input type="hidden" id="amount" className="form-control" /><span className="text-primary">$</span> <p className="inline-block h5 text-primary" id="amount-label">{isValue}</p></li>
                </ul>
            </li>
            ...
            <li className="mt-2 mt-sm-0">
                <ul className="text-md-end brokerage-form list-none">
                    ...
                    <li><input type="hidden" id="saving" className="form-control" /><span className="text-primary">$</span> <p className="inline-block h5 text-primary" id="saving-label">{brokerage}</p></li>
                </ul>
            </li>
        </ul>
        </>
